...
def path_predictor(encoder_model, decoder_model, hyperparams, encoder_input_test, decoder_target_test, n_steps_out):
    ...
    source_trajectories = encoder_input_test[sorted_random_trajectory_samples]
    target_trajectories = decoder_target_test[sorted_random_trajectory_samples]
    ...
    for idx, src_traj in enumerate(source_trajectories):
        ...
        src_traj_batched = np.expand_dims(src_traj, axis = 0)
